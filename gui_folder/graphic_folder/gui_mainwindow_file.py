...
class GuiMainWindowClass(QMainWindow):
    ...
    def create_dashboard_page_method(self) -> QWidget:
        ...
        kpi_row.addWidget(self.kpi_product_to_be_verified)
        kpi_row.addWidget(self.kpi_agreement_to_be_verified)
        kpi_row.addWidget(self.kpi_distributor_to_be_verified)
